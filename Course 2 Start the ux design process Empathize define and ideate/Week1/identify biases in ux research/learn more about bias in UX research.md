...
icon of a hand, finger pressing a button; text reads: choose your words carefully
...
icon of 3 paper airplanes; text reads: foster independent thinking
...
Icon of a magnifying glass magnifying a paper; text reads: avoid specific language
...
icon of a funnel; text reads: limit the guidance you give users.
...
icon of a facial profile, with sound coming out of mouth; text reads: consider users' tone and body language
...
Icon of a person shrugging; text reads: be careful of your own body language and reactions
...
icon of a magnifying glass with a check mark in it; text reads: plan your research effectively
...
Icon of a profile silhouette of a face, text reads: remain open minded
